<template>
    <div class="mx-auto">
        <h1 class="text-3xl font-bold mb-2">Tạo cơ sở lưu trú</h1>
...
const handleSubmit = async () => {
    ...
    try {
        ...
        if (!response) {
            alert('Có lỗi xảy ra khi tạo cơ sở lưu trú.');
        }
        console.log('Accommodation created:', response);
        alert('Cơ sở lưu trú đã được tạo thành công!');
        navigateTo('/admin/dashboard/accommodation');
    } catch (error) {
