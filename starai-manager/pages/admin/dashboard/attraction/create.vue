<template>
    <div class="mx-auto">
        <h1 class="text-3xl font-bold mb-2">Tạo địa điểm du lịch</h1>
...
const handleSubmit = async () => {
    ...
    try {
        ...
        if (!response) {
            alert('Có lỗi xảy ra khi tạo địa điểm du lịch.');
        }
        console.log('Attraction created:', response);
        alert('Địa điểm du lịch đã được tạo thành công!');
        navigateTo('/admin/dashboard/attraction');
    } catch (error) {
